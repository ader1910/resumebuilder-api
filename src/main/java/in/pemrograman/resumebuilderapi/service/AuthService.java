package in.pemrograman.resumebuilderapi.service;

import in.pemrograman.resumebuilderapi.document.User;
import in.pemrograman.resumebuilderapi.dto.AuthResponse;
import in.pemrograman.resumebuilderapi.dto.LoginRequest;
import in.pemrograman.resumebuilderapi.dto.RegisterRequest;
import in.pemrograman.resumebuilderapi.exception.ResourceExistsException;
import in.pemrograman.resumebuilderapi.repository.UserRepository;
import in.pemrograman.resumebuilderapi.util.JwtUtil;
...
public class AuthService {
    ...
    private void sendVerificationEmail(User newUser) {
        ...
        try {
            // Pastikan URL ini sesuai dengan controller Anda
    ...
    public void verifyEmail(String token) {
        ...
        User user = userRepository.findByVerificationToken(token)
                .orElseThrow(() -> {
                    log.error("Token verifikasi tidak ditemukan di database: {}", token);
